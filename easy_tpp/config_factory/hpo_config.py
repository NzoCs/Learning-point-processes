...
class HPOConfig(BaseConfig):
    ...
    def get_required_fields(self) -> List[str]:
        return ['framework_id', 'storage_uri', 'is_continuous', 'num_trials', 'num_jobs']
...
class HPORunnerConfig(BaseConfig):
    ...
    def get_yaml_config(self) -> Dict[str, Any]:
        return {
            'hpo_config': self.hpo_config.get_yaml_config() if self.hpo_config else None,
            'runner_config': self.runner_config.get_yaml_config() if self.runner_config else None
        }
