...
class ConfigTransformer:
    ...
    def transform_trainer_config(config_dict: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if config.get("activate_logging", False):
            ...
            if not hasattr(logger_cfg, '__class__') or logger_cfg.__class__.__name__ != "LoggerConfig":
                ...
                save_dir = config.get("save_dir") or f"./{ckpt}/{model_id}/{dataset_id}/"
    ...
    def transform_data_config(config_dict: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if isinstance(dls, dict):
            config["data_loading_specs"] = ConfigTransformer.transform_data_loading_specs_config(dls)
    ...
    @staticmethod
    def transform_data_loading_specs_config(config_dict: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def _prepare_logger_config(logger_cfg: Dict[str, Any], save_dir: str) -> Dict[str, Any]:
        """
...
class ConfigValidator:
    ...
    @staticmethod
    def validate_required_fields(config_dict: Dict[str, Any], required_fields: List[str], 
    ...
    @staticmethod
    def filter_invalid_fields(config_dict: Dict[str, Any], config_class: Type) -> Dict[str, Any]:
        """
