...
class ModelFactory:
    ...
    def create_model(self, model: Models, model_config: ModelConfig, **kwargs) -> BaseModel:
        """
    ...
    def create_model_by_name(self, model_name: str, model_config: ModelConfig, **kwargs) -> BaseModel:
        """
        ...
        if model_enum is None:
            ...
            raise ValueError(f"Modèle '{model_name}' introuvable. Disponibles: {available}")
