...
def parse_runner_yaml_config(yaml_path: str, experiment_id: str, dataset_id: str) -> Dict[str, Any]:
    """
    ...
    if 'num_event_types' in data_specs:
        ...
        raise ValueError(f"num_event_types not found in data_specs for dataset '{dataset_id}'")
