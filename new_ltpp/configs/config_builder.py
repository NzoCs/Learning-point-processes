...
from .config_factory import ConfigType, config_factory
...
class RunnerConfigBuilder(ConfigBuilder):
    ...
    def __init__(self, config_dict: Dict[str, Any] = None):
        ...
        self.model_builder = ModelConfigBuilder(
            self.config_dict.get("model_config", {})
        )
...
class ModelConfigBuilder(ConfigBuilder):
    ...
    def set_scheduler_config(self, max_epochs: int, lr_scheduler: bool, lr: float):
