...
class CorrAccumulator(BaseAccumulator):
    ...
    def update(self, batch: Batch, simulation: SimulationResult) -> None:
        ...
        acf_sim = self.compute_acf_from_simulation(simulation, self.nb_bins, self.max_lag)
    ...
    def create_hist(
        ...
        bin_indices = torch.where(mask, bin_indices, nb_bins)  # Set masked positions to nb_bins (out of range)
