...
class SimTypeDataExtractor():
    ...
    def extract_simulation_type_values(self, batch: Batch, sim: SimulationResult) -> SimTypeValues:
...
class SimulationDataExtractor():
    ...
    def extract_values(self, batch: Batch, sim: SimulationResult) -> Tuple[SimTimeValues, SimTypeValues]:
