...
## gpu:nvidia_a100_1g.10gb:1pour prod10
...
new-ltpp run --phase all --general-specs-config h64 --training-config e500_b1 --thinning-config e200_s60 --model NHP --data-loading-config b64_w4 --dataset-id taxi --statistical-test-config m_kernel
